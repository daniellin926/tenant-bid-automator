...
const ProcessSection = () => {
  ...
  return (
    <section id="process" className="py-20 px-6 lg:px-0 bg-gray-50 relative overflow-hidden">
                  ...
                  {steps.map((_, i) => (
                    <div 
                      ...
                      className={cn(
                        ...
                        i === activeStep ? "bg-primary w-10" : "bg-gray-200 w-5"
                      )}
  ...
  return (
    <div 
      className={cn(
        ...
        isActive ? "bg-white shadow-subtle" : "hover:bg-white/50 cursor-pointer"
      )}
      onClick={onClick}
    >
      <div className={cn(
        "flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full text-white transition-all duration-300",
      ...
      <div className="flex-1">
        <div className="flex items-center space-x-2 mb-2">
          <div className={cn(
            "w-8 h-8 flex items-center justify-center rounded-lg transition-colors duration-300",
...
const steps = [
  {
    ...
    illustration: (
      <div className="w-full h-full bg-blue-50 flex flex-col items-center justify-center p-5">
  ...
  },
  {
    ...
    icon: <Inbox size={20} />,
    illustration: (
      <div className="w-full h-full bg-purple-50 flex flex-col items-center justify-center p-5">
        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 shadow-sm">
  ...
  },
  {
    ...
    icon: <Users size={20} />,
    illustration: (
      <div className="w-full h-full bg-green-50 flex flex-col items-center justify-center p-5">
        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 shadow-sm">
  ...
  },
  {
    ...
    illustration: (
      <div className="w-full h-full bg-amber-50 flex flex-col items-center justify-center p-5">
        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 shadow-sm">
          <Calendar size={24} className="text-amber-600" />
        </div>
        <div className="grid grid-cols-4 gap-1 mb-4">
          {Array(8).fill(0).map((_, i) => (
            <div key={i} className={`w-8 h-8 rounded-md flex items-center justify-center ${
              [2, 5].includes(i) ? 'bg-amber-200' : 'bg-white'
            }`}>
              {i + 1}
            </div>
          ))}
  ...
  },
  {
    ...
    illustration: (
      <div className="w-full h-full bg-red-50 flex flex-col items-center justify-center p-5">
        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 shadow-sm">
